    ...
    public override void OnInspectorGUI()
    {
        ...
        switch ((int)rr.shape)
        {
            ...
            case 28:
                ...
                break;
            case 29:
                HyperSphereDimensions.radius = EditorGUILayout.FloatField("Radius", HyperSphereDimensions.radius);
                EditorPrefs.SetFloat("HyperSphereRadius", HyperSphereDimensions.radius);
                break;
            case 30:
                DuoCylinderDimensions.r1r2 = EditorGUILayout.Vector2Field("R1 R2", DuoCylinderDimensions.r1r2);
                EditorPrefs.SetFloat("DCR1", DuoCylinderDimensions.r1r2.x);
                EditorPrefs.SetFloat("DCR2", DuoCylinderDimensions.r1r2.y);
                break;
            case 31:
                VerticalCapsuleDimensions.h = EditorGUILayout.FloatField("Height", VerticalCapsuleDimensions.h);
                VerticalCapsuleDimensions.r = EditorGUILayout.FloatField("Radius", VerticalCapsuleDimensions.r);
